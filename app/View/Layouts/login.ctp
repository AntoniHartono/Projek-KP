...
<body>
	<div id="login-page">
	  	<div class="container">
			...
			<div class="form-group">
			<?php echo $this->Form->checkbox('remember_me', array('style' => 'float: left; margin-top: 2px;')); ?> <label style="font-weight:normal; font-size:0.9em;" for="UserRememberMe"> Remember me</label>
			</div>
			<div class="form-group">
  ...
  <?php echo $this->Html->script(array('jquery.min.js', 'bootstrap.min.js', 'jquery.backstretch.min.js')); ?>
	<script type="text/javascript">
		$.backstretch("<?php echo $this->Html->url('/img/background_login.jpg'); ?>", {speed: 500});
