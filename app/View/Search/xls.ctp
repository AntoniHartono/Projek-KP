<?php
  ...
  $xls->openRow();
    ...
    $xls->writeString('Tanggal Meninggal');
    $xls->writeString('Tempat Meninggal');
    $xls->writeString('lainlain');
    $xls->writeString('saran');
  $xls->closeRow();
  ...
  foreach ($search as $data):
    $xls->openRow();
      ...
      $xls->writeString($data['Xls']['email']);
      ...
      $xls->writeString(date('d-m-Y', strtotime($data['Xls']['tgl_meninggal'])));
      $xls->writeString($data['Xls']['tempat_meninggal']); 
      $xls->writeString($data['Xls']['lainlain']);
      $xls->writeString($data['Xls']['saran']);    
